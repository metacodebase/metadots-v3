...
export async function generateMetadata({
  ...
  try {
    ...
    const authorName =
      (blog.author.id as any)?.name || blog.author.name || "Metadots Team";
    ...
    return {
      ...
      keywords:
        blog.tags?.join(", ") ||
        "technology, AI, software development, metadots",
    ...
    return {
      title: "Blog | Metadots",
      description:
        "Latest insights on technology, AI, and software development from Metadots.",
    };
  }
}
...
async function getData(slug: string) {
  try {
    ...
    const blog = await Blog.findOne({ slug, status: "published" }).populate(
      "author.id",
      "name email designation role avatar"
    );
...
export default async function BlogDetailPage({ params }: BlogDetailPageProps) {
  ...
  const getAuthorInfo = (blog: any) => {
    ...
    const authorDesignation =
      (blog.author.id as any)?.designation ||
          ...
          <div className="container max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <Button
                asChild
                variant="ghost"
                className="text-blue-600 bg-blue-50  hover:bg-blue-700 hover:text-white">
                <Link href="/blogs">
                  ...
                  <Card
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute top-3 left-3">
                        <Badge
                          className={`bg-gradient-to-r ${
                            relatedBlog.color || "from-blue-500 to-indigo-600"
                          } text-white text-xs`}>
