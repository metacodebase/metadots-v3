              ...
              <Card className="border-0 shadow-2xl bg-white relative overflow-hidden">
                ...
                <CardHeader className="relative z-10 p-8">
                  ...
                  <form className="space-y-6">
                    ...
                    {/* Submit Button */}
                    <Button className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
          ...
          <div className="py-16">
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  {["About Us", "Portfolio", "Blog", "Careers", "Contact", "Privacy Policy"].map((item, index) => (
                    <li key={item}>
                      <Link
                        href="#"
                        className="text-slate-400 hover:text-white transition-colors duration-300 flex items-center space-x-2 group"
