            ...
            <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 grid gap-8 lg:grid-cols-2 items-center">
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button className="bg-white text-slate-900 hover:bg-white/90 font-medium px-6 py-3" asChild>
                      <Link href="/contact-us">
          ...
          <div className="grid gap-8 lg:grid-cols-3 mb-16">
            ...
            <Card className="group bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:scale-105">
              <CardHeader className="p-8 text-center">
                ...
                <Button className="w-full mt-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white" asChild>
                  <Link href="/contact-us">
                    Learn More
            ...
            <Card className="group bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:scale-105">
              <CardHeader className="p-8 text-center">
                ...
                <Button className="w-full mt-6 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white" asChild>
                  <Link href="/contact-us">
                    Get Quote
                    <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
                  </Link>
            ...
            <Card className="group bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:scale-105">
              <CardHeader className="p-8 text-center">
                ...
                <Button className="w-full mt-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white" asChild>
                  <Link href="/contact-us">
                    Meet Our Engineers
                    <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
                  </Link>
