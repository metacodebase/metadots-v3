    ...
    >
      <CardHeader className="p-0">
        <div className="relative">
          ...
          <div className={`${blog.featuredImage ? 'bg-cover bg-center' : 'bg-gradient-to-r from-blue-600 to-indigo-600'} p-6 relative overflow-hidden transition-all duration-500 ${
            isOpen ? 'h-auto' : 'h-24'
          }`}
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <Badge className="bg-white/20 text-white backdrop-blur">Article</Badge>
