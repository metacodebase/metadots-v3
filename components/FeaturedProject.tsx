              ...
              <div className="grid grid-cols-3 gap-4 py-4">
                {project.metrics.efficiency && (
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{project.metrics.efficiency}</div>
                    <div className="text-sm text-slate-600">Efficiency Gain</div>
                  </div>
                )}
                {project.metrics.dataPoints && (
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{project.metrics.dataPoints}</div>
