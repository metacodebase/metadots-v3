...
export default function PodcastCard({ podcast, isOpen, onToggle }: PodcastCardProps) {
    ...
    >
      <CardHeader className="p-0">
        <div className="relative">
          ...
          <div className={`bg-gradient-to-r from-purple-600 to-pink-600 p-6 relative overflow-hidden transition-all duration-500 ${
            isOpen ? 'h-auto' : 'h-24'
          }`}>
            <div className="absolute inset-0 bg-black/20"></div>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <Badge className="bg-white/20 text-white backdrop-blur">Episode</Badge>
          ...
          <div className={`p-6 transition-all duration-500 ${
            ...
            <CardDescription className={`text-white/70 mb-4 leading-relaxed transition-all duration-500 ${
