...
export function RichTextEditor({
  ...
  const editor = useEditor({
    extensions: [
      ...
      TableHeader.configure({
        HTMLAttributes: {
          class:
            "bg-gray-100 font-semibold text-left p-2 border border-gray-300",
        },
      }),
      TableCell.configure({
        HTMLAttributes: {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.url && editor) {
            ...
            const imageUrl = data.url.startsWith("data:")
              ? data.url
        ...
        toast({
          title: "Upload Failed",
          description:
            "An error occurred while uploading the image. You can still add images via URL.",
          variant: "destructive",
        });
  ...
  return (
    <div
      className={`border rounded-lg w-full bg-white transition-all duration-200 ${
        ...
        <div className="flex items-center gap-1 border-r pr-2">
          <div className="flex items-center gap-1">
            <Button
              ...
              title="Black"
              className=" !text-white  !w-auto h-10 p-0 bg-black hover:bg-gray-800 "
            />
            <Button
              type="button"
              size="sm"
              ...
              title="Blue"
              className=" !text-white  !w-auto h-10 p-0 bg-blue-500 hover:bg-blue-600"
            />
            <Button
              type="button"
              size="sm"
              ...
              title="Red"
              className=" !text-white  !w-auto h-10 p-0 bg-red-500 hover:bg-red-600"
            />
            <Button
              type="button"
              size="sm"
              ...
              title="Green"
              className=" !text-white  !w-auto h-10 p-0 bg-green-500 hover:bg-green-600"
            />
          </div>
          <Button
            type="button"
              ...
              toast({
                ...
                description: (
                  <div className="text-sm space-y-1">
                    ...
                    <div>
                      <strong>Ctrl+V:</strong> Paste (including images)
                    </div>
                    <div>
      ...
      <div className="border-t p-2 bg-gray-50 flex items-center justify-between text-xs text-gray-500">
        <div className="flex items-center space-x-4">
          <span>
            ...
            Cmd+V) or drag and drop images here
          </span>
        </div>
        <div className="flex items-center space-x-4">
          <span>
